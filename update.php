...
$allowed = array('jpg', 'jpeg', 'png');
				...
				$query="UPDATE `customer` SET  name = '$name', careof ='$co', phone ='$phone', village = '$vill', po='$po', pin = '$pin', dist = '$dist', state ='$state', nominee = '$nominee', dob = '$dob', image1='$photo1',image2='$photo2',image3='$photo3' WHERE id=$id ";
